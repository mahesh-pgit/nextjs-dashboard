...
export default async function RevenueChart() {
	...
	return (
		<div className="w-full md:col-span-4">
			<h2 className={`${montserrat.className} mb-4 text-xl md:text-2xl`}>Recent Revenue</h2>

			<div className="rounded-xl border border-zinc-800 p-4">
				<div className="sm:grid-cols-13 mt-0 grid grid-cols-12 items-end gap-2 p-4 md:gap-4">
					<div
